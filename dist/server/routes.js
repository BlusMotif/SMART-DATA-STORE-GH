...
export async function registerRoutes(httpServer, app) {
    ...
    app.post("/api/admin/result-checkers/bulk-upload", requireAuth, requireAdmin, multer({ storage: multer.memoryStorage() }).single('file'), async (req, res) => {
        try {
            if (!req.file) {
    ...
    app.delete("/api/admin/result-checkers/sold", requireAuth, requireAdmin, async (req, res) => {
        try {
    ...
    app.post("/api/wallet/pay", requireAuth, async (req, res) => {
        try {
            ...
            const phoneNumbersData = orderItems
                ...
                : (phoneNumbers ? phoneNumbers.map((phone) => ({ phone: normalizePhoneNumber(phone) })) : undefined);
    ...
    app.get("/api/public/whatsapp-support", async (req, res) => {
        try {
