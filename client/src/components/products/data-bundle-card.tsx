...
export function DataBundleCard({
  ...
  return (
    <Card className="group overflow-visible transition-all duration-200 hover:shadow-lg h-full flex flex-col border-2 dark:border-white" data-testid={`card-bundle-${bundle.id}`}>
      {networkImage && (
