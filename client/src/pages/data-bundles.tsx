            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              {products.map((product) => (
                <Link key={product.id} href={product.href}>
                  <Card
                    className="p-0.5 md:p-1 hover-elevate cursor-pointer transition-all aspect-square flex flex-col items-center justify-center gap-3 border-white dark:border-white"
